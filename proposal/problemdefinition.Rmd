...
-->
Biostrings is an essential package in the R ecosystem, with over one million installations per year (Fig. 1). This places Bioconductor as the 11th most popular package on the Bioconductor platform. Over 500 packages on Bioconductor and 65 packages on CRAN depend on or import Biostrings. 
